                        ...
                        <div className="modal-body">
                            <div className="tabs mt-3">
                                <ul className='nav nav-tabs' id='my-Tab' role='tablist'>
                                    <li className='nav-item' role='presentataion'>
                                        <a
                                ...
                                {/* Payment Desclaimer */}
                                <p className='mt-3 px-4 p-Disclaimer'><em>Payment desclaimer:</em> In no event shall payment or partial payment by owner for any materialor service</p>
                            </div>
                        </div>
                    </div>
                </div>
